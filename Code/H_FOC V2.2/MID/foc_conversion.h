...
*/
extern inline void clark_transform(void *abc_i, AlphaBetaTypeDef *alpha_beta);
 ...
 */
extern inline void park_transform(AlphaBetaTypeDef *alpha_beta, foc_control_t *foc_ctrl, float32_t sin_theta, float32_t cos_theta);
